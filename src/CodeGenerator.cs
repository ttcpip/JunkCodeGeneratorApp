...
namespace JunkCodeGeneratorApp.src
{
    public class CodeGenerator
    {
        ...
        public string GetRandIndexToGetValueFromArray()
        {
            var index = Rand.Int(0, Opts.MaxIndexToGetValueFromArray + 1);
        ...
        public string GetRandMathExpression()
        {
            ...
            var functions = new string[]
            {
                ...
                $"{mathLibPath}.Abs({Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Abs({Placeholders.RANDOM_INT_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",

                $"{mathLibPath}.BigMul({Placeholders.RANDOM_INT_VALUE}, {Placeholders.RANDOM_INT_VALUE})",
                $"{mathLibPath}.BigMul({Placeholders.RANDOM_INT_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}], {Placeholders.RANDOM_INT_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",

                $"{mathLibPath}.Ceiling({Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Ceiling({Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Ceiling((double){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Ceiling((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Ceiling({mathEConst})",
                $"{mathLibPath}.Ceiling({mathPIConst})",

                $"{mathLibPath}.Cos((double){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Cos((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                ...
                $"{mathLibPath}.Cosh((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",

                $"{mathLibPath}.Exp((double){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Exp((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Exp({mathEConst})",
                $"{mathLibPath}.Exp({mathPIConst})",

                $"{mathLibPath}.Floor((double){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Floor((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Floor({Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Floor({Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Floor((double){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Floor((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                ...
                $"{mathLibPath}.IEEERemainder((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}], (double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.IEEERemainder({mathEConst}, (double){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.IEEERemainder((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}], {mathPIConst})",
                ...
                $"{mathLibPath}.Log((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Log((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}], (double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Log10((double){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Log10((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",

                $"{mathLibPath}.Max({Placeholders.RANDOM_DECIMAL_VALUE}, {Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Max({Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}], {Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Max((float){Placeholders.RANDOM_DECIMAL_VALUE}, (float){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Max((float){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}], (float){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Max({Placeholders.RANDOM_INT_VALUE}, {Placeholders.RANDOM_INT_VALUE})",
                $"{mathLibPath}.Max({Placeholders.RANDOM_INT_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}], {Placeholders.RANDOM_INT_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Max({Placeholders.RANDOM_BYTE_VALUE}, {Placeholders.RANDOM_BYTE_VALUE})",
                $"{mathLibPath}.Max({Placeholders.RANDOM_BYTE_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}], {Placeholders.RANDOM_BYTE_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",

                $"{mathLibPath}.Min({Placeholders.RANDOM_DECIMAL_VALUE}, {Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Min({Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}], {Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Min((float){Placeholders.RANDOM_DECIMAL_VALUE}, (float){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Min((float){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}], (float){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Min({Placeholders.RANDOM_INT_VALUE}, {Placeholders.RANDOM_INT_VALUE})",
                $"{mathLibPath}.Min({Placeholders.RANDOM_INT_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}], {Placeholders.RANDOM_INT_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Min({Placeholders.RANDOM_BYTE_VALUE}, {Placeholders.RANDOM_BYTE_VALUE})",
                $"{mathLibPath}.Min({Placeholders.RANDOM_BYTE_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}], {Placeholders.RANDOM_BYTE_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",

                $"{mathLibPath}.Pow((double){Placeholders.RANDOM_DECIMAL_VALUE}, (double){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Pow((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}], (double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                ...
                $"{mathLibPath}.Round({Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Round((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",

                $"{mathLibPath}.Sign({Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Sign({Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Sign({mathEConst})",
                $"{mathLibPath}.Sign({mathPIConst})",
                $"{mathLibPath}.Sign((double){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Sign((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Sign((float){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Sign((float){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Sign({Placeholders.RANDOM_INT_VALUE})",
                $"{mathLibPath}.Sign({Placeholders.RANDOM_INT_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",

                $"{mathLibPath}.Sin((double){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Sin((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Sinh((double){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Sinh((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                ...
                $"{mathLibPath}.Sqrt((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",

                $"{mathLibPath}.Tan((double){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Tan((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Tan({mathEConst})",
                $"{mathLibPath}.Tan({mathPIConst})",
                $"{mathLibPath}.Tanh((double){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Tanh((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Tanh({mathEConst})",
                $"{mathLibPath}.Tanh({mathPIConst})",

                $"{mathLibPath}.Truncate((double){Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Truncate((double){Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
                $"{mathLibPath}.Truncate({Placeholders.RANDOM_DECIMAL_VALUE})",
                $"{mathLibPath}.Truncate({Placeholders.RANDOM_DECIMAL_ARRAY_VALUE}[{Placeholders.RANDOM_INDEX_TO_GET_VALUE_FROM_ARRAY}])",
